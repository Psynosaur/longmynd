...
/* -------------------------------------------------------------------------------------------------- */
    uint8_t err = ERROR_NONE;
    if (err==ERROR_NONE) err=stv0910_write_reg(RSTV0910_P1_TSCFGH, 0x61); /* assert RST_HWARE (serial mode 0x60|0x01) */
    if (err==ERROR_NONE) err=stv0910_write_reg(RSTV0910_P1_TSCFGH, 0x60); /* deassert RST_HWARE (serial mode) */
    return err;
}
