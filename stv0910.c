...
/* -------------------------------------------------------------------------------------------------- */
    ...
    if (err==ERROR_NONE) err=stv0910_write_reg(RSTV0910_P1_TSCFGH, 0x01); /* assert RST_HWARE (P1: DVBCI=0, parallel mode) */
    if (err==ERROR_NONE) err=stv0910_write_reg(RSTV0910_P2_TSCFGH, 0x81); /* assert RST_HWARE (P2: DVBCI=1) */
    if (err==ERROR_NONE) err=stv0910_write_reg(RSTV0910_P1_TSCFGH, 0x00); /* deassert RST_HWARE (P1: DVBCI=0, parallel) */
