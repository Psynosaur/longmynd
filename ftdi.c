...
/* -------------------------------------------------------------------------------------------------- */
/* Leaves TS2SYNC (AC1) as an input — open_tuner never drives this pin (direction=0xf1, bit1=0).     */
/* The STV0910 drives AC1 directly as a TS signal. Driving it from FTDI fights the STV0910.          */
/* -------------------------------------------------------------------------------------------------- */
{
    printf("Flow: FTDI TS2SYNC: leaving AC1 as input (open_tuner behaviour)\n");

    /* Ensure TS2SYNC is an input — clear direction bit */
